...
exports.default = (options, app) => {
    ...
    return {
        ...
        onInitialized: (a) => {
            console.log(utils_1.path.resolve(__dirname, '@vuepress/theme-default/lib/client/code.scss'));
            console.log(fs_1.default.readFileSync('../node_modules/@vuepress/theme-default/lib/client/code.scss'));
        },
    };
};
