...
const match_braces_1 = __importDefault(require("./match-braces"));
...
const inline_style_1 = __importDefault(require("./browser/inline-style"));
...
function loadPlugins(md, app, options) {
    ...
    if (pluginMap['match-braces']) {
        setHead(app, 'script', {}, match_braces_1.default.toString());
    }
    if (pluginMap.toolbar) {
    ...
    if (pluginMap.previewers) {
        setHead(app, 'script', {}, fs_1.default.readFileSync(utils_1.path.resolve(__dirname, './previewers/index.js')).toString()
